...
from user_course_routes import register_user_course_routes
...
register_user_course_routes(app, ApiResponse, sanitize_text, sanitize_html, now_iso, logger, parse_json)
